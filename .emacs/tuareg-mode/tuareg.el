...
(defconst tuareg-mode-version "Tuareg Version 1.46.0rc4"
  "        Copyright © 1997-2006 Albert Cohen, all rights reserved.
...
(defun tuareg-find-match ()
  (tuareg-find-kwop (tuareg-give-find-kwop-regexp)))
...
(defun tuareg-compute-indent ()
  (save-excursion
	...
	(+ tuareg-default-indent (current-column))))
     ...
     ((looking-at (tuareg-give-matching-kwop-regexp))
